...
def demo(args):
    ...
    with torch.no_grad():
        ...
        for (imfile1, imfile2) in tqdm(list(zip(left_images, right_images))):
            ...
            output_dir = os.path.join(output_directory, imfile1.split('/')[-3])

            if not os.path.exists(output_dir):
                os.makedirs(output_dir)

            file_stem = os.path.join(output_dir, imfile1.split('/')[-1])
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--left_imgs', help="path to all first (left) frames", default="/data/StereoDatasets/sceneflow/frames_finalpass/TEST/A/*/left/*.png")
    parser.add_argument('-r', '--right_imgs', help="path to all second (right) frames", default="/data/StereoDatasets/sceneflow/frames_finalpass/TEST/A/*/right/*.png")
    ...
    parser.add_argument('--output_directory', help="directory to save output", default="./output/sceneflow")
